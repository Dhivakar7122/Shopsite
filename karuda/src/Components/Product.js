  ...
  return (
    <div className="container-fluid">
      <div className="product1">
        <div className="p-4">
          <h1 className="p1h1 text-white">Our Product's</h1>
        ...
        <div className="row p-4">
          ...
          <div className="col-md-6">
            <img src={tcup} className="img-fluid" alt="no Image" />
          </div>
        </div>
      </div>
      ...
      <div className="ownprod">
        <div className="normalpro">
          <div className="col-md-6 ncon p-4">
            ...
            <h3>How to Brew:</h3>
            <ol>
              <li>Add one teaspoon of Normal Estate Tea to a cup.</li>
            ...
            <div className="pordercon">
              ...
              <button className="porderbtn btn btn-dark" onClick={handleclick}><FaCartArrowDown /> Order Now</button>
            </div>
          </div>
          <div className="col-md-6">
        ...
        <div className="elachi row">
          <div className="col-md-6 elachicon p-4">
            <h2>Elachi Tea</h2>
            <h3>Description:</h3>
            ...
            <h3>How to Brew:</h3>
            <ol>
              <li>Add one teaspoon of Elachi Tea to a cup.</li>
              <li>Pour boiling water over the tea.</li>
              <li>Let it steep for 3-5 minutes.</li>
          ...
          <div className="col-md-6 elachiimg">
            <img src={elachi1} className="img-fluid" alt="no image" />
          </div>
        </div>

        <div className="naturaltea row">
          <div className="col-md-6 naturalteacon p-4">
            ...
            <h3>How to Brew:</h3>
            <ol>
              <li>Add one teaspoon of Natural Care Tea to a cup.</li>
              <li>Pour boiling water over the tea.</li>
          ...
          <div className="col-md-6 naturalimg">
